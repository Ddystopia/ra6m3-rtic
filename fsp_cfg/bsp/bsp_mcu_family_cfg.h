...
#ifdef NDEBUG
// release build, IWDT enabled
# define OFS_SEQ1 0xA001A001 | (0 << 1) | (1 << 2)
# define OFS_SEQ2 (4 << 4)  | (3 << 8) | (3 << 10)
# define OFS_SEQ3 (1 << 12) | (0 << 14) | (1 << 17)
#else
// debug build, IWDT disabled
...
#define BSP_CFG_ROM_REG_OFS1 (0xFFFFFEF8 | (0 << 2) | (3) |  (1 << 8))
